...
void Paper::GenerateTitle() {
	...
	char subjects[][50] = { "Lithium-ion Batteries", "3D Printing", "Space Travel", "Big Data Trends", "Climate Change",
	...
	char methods[][50] = { "Neural Networks", "Hilbert Spaces", "Ecological Networks", "Game Theory", "Cayley Graphs",
	...
	char adj[][50] = { "Randomized", "Stochastic", "Computable", "Equivalent", "Connected",
	...
	char verbs[][50] = { "Investigating", "Improving", "Observing", "Analyzing", "Determining Effects of",
...
void Paper::PrintJournal() {
	for (int i = 0; i<strlen(journal); i += 1) {
		printf("%c", journal[i]);
	}
}
